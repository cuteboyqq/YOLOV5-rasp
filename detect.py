                    ...
                    if GANOMALY:
                        ...
                        if c==0 and float(conf) < float(ganomaly_conf) and filter_line_label==False:
                            ...
                            if loss>LOSS and conf < ganomaly_conf:
                                print('ab-normal line--ab-normal line--ab-normal line--ab-normal line {}--{}, time: {} ms'.format(loss,loss,during_GANomaly_detect_image))
                            else:
                                print('normal-normal-normal-normal-normal-normal-normal {}-- {}, time: {} ms'.format(loss,loss,during_GANomaly_detect_image))
                            '''
