...
# 建立佇列
get_frame_queue = queue.Queue(60)
my_queue = queue.Queue(60)
parameter_queue = queue.Queue(60)
get_frame_and_model_infer_queue = queue.Queue(60)
MULTI_PROCESS=False
MULTI_THREAD=True
frame_cnt = 1
...
def Get_Frame_and_model_Inference_2thread_version(my_queue,
                                                  model,
                                                  dataset,
                                                  visualize,
                                                  save_dir,
    ...
    while True:
        ...
        #pred_global = pred
        #=================Alister add 2023-02-27======================
        get_frame_and_model_infer_queue.put([im,path,s,vid_cap,pred,im0s])
        #print("[model_inference]pred_global = {}".format(pred_global))
        #return pre2
...
def PostProcess_2thread_version(my_queue,
        pred, conf_thres, iou_thres, classes, agnostic_nms, max_det,
                source,
                path,
                im0s,
    ...
    while True:
        ...
        #sem2.acquire() #sem2=0
        #=======Alister add 2023-02-27=============
        q_data=get_frame_and_model_infer_queue.get()
        im_from_queue,path_from_queue,s_from_queue,vid_cap_from_queue,pred_from_queue,im0s_from_queue = q_data
        #im_from_queue,path_from_queue,pred_from_queue,im0s_from_queue = q_data
        #Alister add 2023-03-02 #Failed
        #====================================================
...
if __name__ == "__main__":
    ...
    if MULTI_THREAD:
        ...
        if THREE_THREADS: #using 3 threads
        ...
        else: #using 2 threads
            
            #===========combine Get_frame & model_inference============================================
            print("before t1")
            t1 = threading.Thread(target = Get_Frame_and_model_Inference_2thread_version ,args=(my_queue,
                                                                                model,
                                                                                dataset,
                                                                                visualize,
                                                                                save_dir,
            ...
            #========================
            print("before t3")
            t3 = threading.Thread(target = PostProcess_2thread_version, args=(my_queue,
                                                                None,#pred_global
                                                              conf_thres, 
                                                              iou_thres, 
                                                              classes, 
