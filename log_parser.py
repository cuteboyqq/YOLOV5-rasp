...
def video_extract_frame(path,skip_frame,txt_dir,class_path,img_size,yolo_infer_txt):
    ...
    if SAVE_RAW_STREAM:
        ...
        s_time = str(s_time)
        save_path = r"C:/GitHub_Code/cuteboyqq/YOLO/"+ s_time + "_offline_log"+ ".avi"
        w,h=SET_W,SET_H
        fps=SET_FPS
...
def get_args():
    ...
    parser.add_argument('-videopath','--video-path',help="input video path",default=r"C:\GitHub_Code\cuteboyqq\YOLO\0.avi")
...
if __name__=="__main__":
    ...
    #yolo_txt_dir = r"C:\GitHub_Code\cuteboyqq\YOLO\YOLOV5-rasp\runs\detect\2023-03-1819\labels"
