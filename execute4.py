# -*- coding: utf-8 -*-
"""
Created on Sun Mar 12 16:53:52 2023

@author: User
"""
import sys
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QListView, QPushButton, QVBoxLayout
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.listView_model = QStringListModel(["Save raw video", "Save AI result video", "Save anomaly images"])
    ...
    def execute_command(self):
        ...
        #selected_options = [str(self.listView.model().data(index)) for index in self.listView.selectedIndexes()]
        selected_options = [str(self.listView.model().data(index, Qt.DisplayRole)) for index in self.listView.selectedIndexes()]
        ...
        if "Save AI result video" in selected_options:
            command_options += " --save_ai_video"
        if "Save anomaly images" in selected_options:
            command_options += " --save_anomaly_images"
